...
$zeka_theme_divider_style = array(
...
return array(
	...
	'icons'                        => $zeka_theme_svg_icons,
	'divider_style'                => $zeka_theme_divider_style,
	'lorem_ipsum'                  => $zeka_lorem_ipsum,
	'edit_this_text_in_customizer' => $zeka_theme_click_pen_to_edit_title,
	'gradients'                    => $zeka_gradients,
	...
	'front-header' => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $zeka_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $zeka_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $zeka_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'left',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $zeka_gradients['night_fade'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $zeka_theme_svg_icons['facebook-square'],
						'link_value' => 'https://www.facebook.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $zeka_theme_svg_icons['instagram-square'],
						'link_value' => 'https://www.instagram.com/',
						'index'      => 1,
					),
					array(
						'icon'       => $zeka_theme_svg_icons['youtube-play'],
						'link_value' => 'https://www.youtube.com/',
						'index'      => 2,
					),
					array(
						'icon'       => $zeka_theme_svg_icons['reddit'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $zeka_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $zeka_theme_svg_icons['twitter'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $zeka_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $zeka_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					...
					array(
						'icon'       => $zeka_theme_svg_icons['phone-square'],
						'text'       => '+400 098 765 432',
						'link_value' => '#',
						'index'      => 1,
					),
	...
	'blog_post_thumb_placeholder_color' => 'rgb( 176,190,197)',
